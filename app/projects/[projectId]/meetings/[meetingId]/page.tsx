...
export default function MeetingDetail() {
  ...
  const meetingId = (params.meetingId as string) || "m1";
  ...
  }, [projectId, meetingId, meetingTitle]);
      ...
      <div className="px-6 py-4 flex flex-col">
        <section className="mb-4 space-y-4 flex-shrink-0" data-testid="section-summary">
          <div className="grid grid-cols-2 gap-4">
            ...
            <Card className="col-span-2" data-testid="logic-findings-card">
              <CardHeader className="py-3 px-4 border-b border-border">
                <CardTitle className="text-sm font-medium flex items-center gap-2">
